INSERT INTO `gutenbook`.`usuario` (`IDusuario`, `usuario`, `nombre`, `correoElectronico`, `telefono`, `contraseña`, `administrador`) VALUES (null, 'ximenita231', 'Ximena Fernanda Cortes Perales', 'Perales58@gmail.com', 5566558931, 'pordas89@', true);
INSERT INTO `gutenbook`.`usuario` (`IDusuario`, `usuario`, `nombre`, `correoElectronico`, `telefono`, `contraseña`, `administrador`) VALUES (null, 'eminajas', 'Emmanuel Minajas', 'eminajas@gmail.com', 5584621400, 'FerrarI21@', false);
INSERT INTO `gutenbook`.`usuario` (`IDusuario`, `usuario`, `nombre`, `correoElectronico`, `telefono`, `contraseña`, `administrador`) VALUES (null, 'virivañia', 'Vivian Mendez', 'vivilk@gmail.com', 5584621401, 'Jung-hoseok13@', false);
INSERT INTO `gutenbook`.`usuario` (`IDusuario`, `usuario`, `nombre`, `correoElectronico`, `telefono`, `contraseña`, `administrador`) VALUES (null, 'jalbert', 'Jose Alberto Torres ', 'joseTor@hotmail.com', 5523638541, '@Mario23.', false);
INSERT INTO `gutenbook`.`usuario` (`IDusuario`, `usuario`, `nombre`, `correoElectronico`, `telefono`, `contraseña`, `administrador`) VALUES (null, 'oliver5', 'Oliver Bustamante Peralta', 'oliver456@gmail.com', 5523876222, 'HOLA1234@', false);
...
INSERT INTO `gutenbook`.`libro` (`libroID`, `titulo`, `autor`, `url`, `genero`, `anoPublicacion`, `precio`, `pais`, `editorial`) 
